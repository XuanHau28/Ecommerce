...
const Profile = ({ history }) => {
  ...
  return (
    <Fragment>
        ...
        <div className='profileContainer flex flex-col lg:flex-row h-[100vh] w-[100vw] left-0 fixed top-0 pt-[100px] lg:pt-[50px] max-w-[100%] bg-white'>
            <div className='flex h-[100vh] w-[100vw] max-w-[100%] flex-col justify-center items-center'>
                ...
                <Link
                className='border-none p-[1vmax] lg:p-0 bg-[rgba(40,111,108)] font-normal text-[2vmax] lg:text-[1vmax] text-white text-center transition-all 
